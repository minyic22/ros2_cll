...
class Shape(metaclass=Metaclass_Shape):
    ...
    def __init__(self, **kwargs):
        ...
        self.shape_type_code = kwargs.get('shape_type_code', int())
    ...
    def __eq__(self, other):
        ...
        if self.shape_type != other.shape_type:
            return False
        if self.shape_type_code != other.shape_type_code:
            return False
    ...
    @builtins.property
    def shape_type_code(self):
        """Message field 'shape_type_code'."""
        return self._shape_type_code

    @shape_type_code.setter
    def shape_type_code(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'shape_type_code' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'shape_type_code' field must be an unsigned integer in [0, 4294967295]"
        self._shape_type_code = value
