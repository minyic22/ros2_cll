...
#include "interface/msg/detail/shape__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // param_values, params_to_vary, path
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // param_values, params_to_vary, path
...
using _Shape__ros_msg_type = interface__msg__Shape;
...
size_t get_serialized_size_interface__msg__Shape(
  const void * untyped_ros_message,
...
static uint32_t _Shape__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface__msg__Shape(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interface
size_t max_serialized_size_interface__msg__Shape(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Shape__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface__msg__Shape(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface, msg, Shape)() {
