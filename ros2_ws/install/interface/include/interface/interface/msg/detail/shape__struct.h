...
#ifndef INTERFACE__MSG__DETAIL__SHAPE__STRUCT_H_
#define INTERFACE__MSG__DETAIL__SHAPE__STRUCT_H_
...
/// Struct defined in msg/Shape in the package interface.
typedef struct interface__msg__Shape
{
  /// the trajectory of the shape
...
// Struct for a sequence of interface__msg__Shape.
typedef struct interface__msg__Shape__Sequence
{
...
#endif  // INTERFACE__MSG__DETAIL__SHAPE__STRUCT_H_
