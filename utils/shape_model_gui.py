...
def preparePlot(shapeModeler):
    ...
    sliders = [0]*numParams;
    for i in range(numParams):
        slider = Slider(plt.axes([0.25, 0.1+0.05*(numParams-i-1), 0.65, 0.03], facecolor=axcolor),
...
if __name__ == "__main__":
    ...
    if(not datasetDirectory):
        ...
        datasetDirectory = r'/mnt/c/Users/minyi/Desktop/ros2_cll/utils/letter_model_datasets/alexis_set_for_children'
